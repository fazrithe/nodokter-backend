...
@section('subcontent')
    <h2 class="intro-y text-lg font-medium mt-10">Data Produts</h2>
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            <a class="btn btn-primary shadow-md mr-2" href="{{ route('products.create') }}">Add New Product</a>
                        ...
                        <tr class="intro-x">
                            ...
                            <td>
                                <div class="flex">
                                    <div class="w-10 h-10 image-fit zoom-in">
                                        <img alt="Icewall Tailwind HTML Admin Template" class="tooltip rounded-full" src="{{ asset($value->image_path) }}" title="{{ $value->name }}">
                                    </div>
                                </div>
                            </td>
                            <td>
                            ...
                            <td class="table-report__action w-56">
                                <div class="flex justify-center items-center">
                                    <a class="flex items-center mr-3" href="{{ route('products.edit',$value->id) }}">
                                        Edit
                                    </a>
